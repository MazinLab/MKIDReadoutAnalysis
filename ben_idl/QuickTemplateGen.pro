...
plot,data[1,1:lines/2-1],data[3,1:lines/2-1],/ynozero,/xstyle,psym=3
xc1 = fitdat[16,0] + Iz1
yc1 = fitdat[17,0] + Qz1
...
plot,data[1,lines/2:lines-1 ],data[3,lines/2:lines-1],/ynozero,/xstyle,psym=3
xc2 = fitdat[16,1] + Iz2
yc2 = fitdat[17,1] + Qz2
