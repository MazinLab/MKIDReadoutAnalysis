...
;total( abs(P1f-ch1d[i]*FFT(shift(t1[900:1699],mx-20),-1)*!Pi/180.0)^2/ch1nc)*(1.25d-6*800.0)/800.0
...
printf,2,'Expected std dev of pulses phase (degrees)',optns1*180.0/!Pi,optns2*180.0/!Pi
...
cmd = strcompress('cupsfilter ' + outpath + 'ResEstimates.txt > ' + outpath + 'ResEstimates.pdf')
SPAWN,cmd
